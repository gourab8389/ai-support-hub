...
workspaceRoutes.post('/:workspaceId/api-keys', validate(generateApiKeySchema), (c) => workspaceController.generateApiKey(c));
...
workspaceRoutes.patch('/:workspaceId/members/:memberId', validate(updateMemberRoleSchema), (c) => workspaceController.updateMemberRole(c));
